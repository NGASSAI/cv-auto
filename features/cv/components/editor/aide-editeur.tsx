        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            ...
            <div className="pl-10 space-y-2 text-sm text-muted-foreground">
              <p>
                • Remplissez votre <strong>nom</strong>,{" "}
                <strong>prénom</strong> et{" "}
                <strong>titre du poste</strong> souhaité
              </p>

              <p>
                • Ajoutez votre <strong>email</strong> et{" "}
                <strong>téléphone</strong> pour être contacté
              </p>

              <p>
                • Écrivez un <strong>résumé</strong> court de qui vous êtes
                (2-3 phrases)
              </p>
              ...
              <div className="flex items-center gap-2 p-3 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <p className="text-blue-800 text-xs">
                  ...
                  <span>&quot;Suggestions IA&quot;</span> pour obtenir des
                  idées de compétences automatiquement
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="pl-10 space-y-2 text-sm text-muted-foreground">
              ...
              <ul className="list-disc list-inside space-y-1 ml-2">
                <li>
                  <strong>Expérience professionnelle</strong> : vos jobs
                  précédents
                </li>
                <li>
                  <strong>Formation</strong> : vos diplômes et études
                </li>
                <li>
                  <strong>Compétences</strong> : ce que vous savez faire
                </li>
                <li>
                  <strong>Langues</strong> : les langues que vous parlez
                </li>
                <li>
                  <strong>Projets</strong> : vos projets personnels ou
                  professionnels
                </li>
              </ul>
            </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-purple-50 rounded-lg border border-purple-200">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-purple-700">
                      Cliquez pour ajouter un nouvel élément (une expérience,
                      une formation, etc.)
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-orange-50 rounded-lg border border-orange-200">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-orange-700">
                      Cliquez pour masquer ou afficher la section dans le CV
                      final
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-red-50 rounded-lg border border-red-200">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-red-700">
                      Cliquez pour supprimer toute la section (attention,
                      irréversible !)
                    </p>
                  </div>
                </div>
          ...
          <div className="space-y-3">
            ...
            <div className="pl-10 space-y-2 text-sm text-muted-foreground">
              <p>
                • Choisissez un <strong>template</strong> (modèle) de CV dans
                le menu à droite
              </p>

              <p>
                • Changez la <strong>couleur</strong> pour personnaliser
                l&apos;apparence
              </p>

              <p>
                • Sélectionnez une <strong>police</strong> d&apos;écriture que
                vous aimez
              </p>
              ...
              <div className="flex items-center gap-2 p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                ...
                <p className="text-yellow-800 text-xs">
                  <strong>Premium :</strong> Vous pouvez ajouter votre photo de
                  profil
                </p>
              </div>
            </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-red-800">
                      Vous avez un{" "}
                      <strong>nombre limité de téléchargements PDF</strong>.
                    ...
                    <ul className="list-disc list-inside space-y-1 text-red-700 ml-2">
                      ...
                      <li>
                        Utilisez l&apos;aperçu à droite pour voir le résultat
                      </li>
                      <li>
                        Téléchargez uniquement quand vous êtes satisfait
                      </li>
                    </ul>

                    <p className="text-red-700 font-medium mt-2">
                      💡 Conseil : Faites toutes vos modifications d&apos;abord,
                      puis téléchargez une seule fois à la fin.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-blue-200">
            ...
            <ol className="text-sm space-y-1 text-muted-foreground">
              ...
              <li>
                4. Choisissez votre style (template, couleur, police)
              </li>
              <li>5. Vérifiez le résultat dans l&apos;aperçu</li>
              <li>
                6. Téléchargez SEULEMENT quand vous êtes satisfait
              </li>
            </ol>
          </div>
        </div>
