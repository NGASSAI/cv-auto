...
const styles = StyleSheet.create({
  page: { fontSize: 10, fontFamily: "Helvetica", color: "#161B22", flexDirection: "row" },
  aside: { width: "34%", padding: 20, color: "#FFFFFF" },
  photo: { width: 80, height: 80, borderRadius: 40, alignSelf: "center", marginBottom: 16 },
  photoFallback: { width: 80, height: 80, borderRadius: 40, alignSelf: "center", marginBottom: 16, backgroundColor: "rgba(255,255,255,0.15)", alignItems: "center", justifyContent: "center" },
    ...
    {informations.resume}
          ...
          {sectionsPrincipales.map((section) => (
            <View key={section.id} style={styles.section}>
              <Text style={[styles.sectionTitre, { color: couleurAccent, borderBottom: `2px solid ${couleurAccent}` }]}>
                {section.titre}
              </Text>
              {section.items.map((item) => (
